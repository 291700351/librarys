...
open class BaseFragment<VB : ViewDataBinding, VM : BaseViewModel> : Fragment(),
    ...
    protected val mContext: Context by lazy { this.requireActivity() }
    ...
    private fun hideActionbar() {
        ...
        a.supportRequestWindowFeature(Window.FEATURE_NO_TITLE)
    }
